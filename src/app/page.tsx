  ...
  const projects = [
    {
      ...
      link: "#",
      technologies: ["TypeScript", "React", "NextJS", "AntD", "SCSS", "HTML"],
    },
    {
  ...
  const experience = [
    {
      label: "AUG 2022",
      children:
        "Software Engineer Intern at Lanex Corporation + Last year of college",
      color: "green",
    },
    {
      label: "JAN 2023 - PRESENT",
      children: "Software Engineer at Lanex Corporation",
      color: "green",
    },
  ];
  const switchItems = [
  ...
  return (
    <>
      ...
      <Col className="contacts-container">
        <Text className="contact">Let's connect</Text>
